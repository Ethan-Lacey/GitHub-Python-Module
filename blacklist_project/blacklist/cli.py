import sys
import argparse
from functions import blockHost, removeHost, getHostPath
...
def commandLine():
    ...
    blockParser = subparsers.add_subparsers("block", help="Block a Fully Qualified Domain Name")
    blockParser.add_argument("FQDN", type=str, help="Enter the Fully Qualified Domain Name you wish to block.")

    unblockParser = subparsing.add_parser("unblock", help="Unblock a Fully Qualified Domain Name")
